...
{
    getGameRecordPrx(req.uid)->async_reportKOUserActInfo(NULL, req);
    return 0;
}

//异步上报用户帐号信息
int OuterFactoryImp::asyncReportQSUserActInfo(const gamerecord::ReportQSUserActInfoReq &req)
{
    getGameRecordPrx(req.uid)->async_reportQSUserActInfo(NULL, req);
    return 0;
}
